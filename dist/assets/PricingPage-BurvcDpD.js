import{b as $,aR as ae,d as re,ah as te,u as se,aS as ie,r as w,j as e,bb as ne,k as v,A as oe,ar as le,aU as U,aB as ce,aq as de,bk as pe,bj as xe,bl as fe,aV as B,P as me,X as ue,ap as ge,al as be,aZ as he,a$ as ye,s as A,bm as we}from"./index-Buval7va.js";import{L as ve,S as je}from"./ScratchCardSection-DlhxGYr_.js";/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const D=$("BarChart3",[["path",{d:"M3 3v18h18",key:"1s2lah"}],["path",{d:"M18 17V9",key:"2bz60n"}],["path",{d:"M13 17V5",key:"1frdt8"}],["path",{d:"M8 17v-3",key:"17ska0"}]]);/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const J=$("Infinity",[["path",{d:"M12 12c-2-2.67-4-4-6-4a4 4 0 1 0 0 8c2 0 4-1.33 6-4Zm0 0c2 2.67 4 4 6 4a4 4 0 0 0 0-8c-2 0-4 1.33-6 4Z",key:"1z0uae"}]]);/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ke=$("Unlock",[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 9.9-1",key:"1mm8w8"}]]),K="https://eojryhfwtnjyegqhiust.supabase.co/functions/v1/razorpay",Ne=[{id:"ONE_WEEK",name:"1 Week",label:"Trial",price:49,floorPrice:29,originalPrice:299,priceNote:"₹49 / week",icon:le,iconColor:"#f43f5e",featured:!1,days:7},{id:"ONE_MONTH",name:"1 Month",label:"Starter",price:249,floorPrice:99,originalPrice:499,priceNote:"₹249 / month",icon:U,iconColor:"#3b82f6",featured:!1},{id:"THREE_MONTHS",name:"3 Months",label:"Super Saver",price:399,floorPrice:249,originalPrice:799,priceNote:"₹133 / month",icon:D,iconColor:"#10b981",featured:!1},{id:"SIX_MONTHS",name:"6 Months",label:"Trending",price:499,floorPrice:349,originalPrice:1199,priceNote:"₹83 / month",icon:ce,iconColor:"#f59e0b",featured:!1,badge:{text:"Trending",color:"#f59e0b"}},{id:"ONE_YEAR",name:"1 Year",label:"Popular",price:599,floorPrice:449,originalPrice:1999,priceNote:"₹50 / month",icon:de,iconColor:"#6366f1",featured:!1,badge:{text:"Popular",color:"#3b82f6"}},{id:"LIFETIME",name:"Lifetime",label:"Best Value",price:1149,floorPrice:999,originalPrice:4999,priceNote:"₹7 / month equivalent",icon:J,iconColor:"#a855f7",featured:!0,badge:{text:"Best Value",color:"#a855f7"}}],_e=[{icon:ke,label:"Unlock all mock tests & PYQs",desc:"Full access to current and upcoming exam papers",color:"#10b981"},{icon:pe,label:"Mint double Kash Coins",desc:"Earn 2X rewards on correct answers to build streaks",color:"#fbbf24"},{icon:xe,label:"Master AI Mentor",desc:"Direct, premium hints & question diagnostic support",color:"#c084fc"},{icon:fe,label:"Spaced Repetition (SRS)",desc:"Smart card sets focusing on your weakest areas",color:"#3b82f6"},{icon:D,label:"Advanced Analytics",desc:"Track speed index, correct ratios, and accuracy trends",color:"#22d3ee"},{icon:B,label:"Ad-Free Interface",desc:"Fully distraction-free study environment",color:"#f87171"}];function Ce(){const j=ae(),{user:m}=re(),{economy:r,refreshEconomy:E}=te(),{showToast:c}=se(),{playVictory:V}=ie(),O=()=>{try{const t=`mcqkash_scratch_history_${(r==null?void 0:r.username)||"default"}`;let i=JSON.parse(localStorage.getItem(t)||"[]");if(r&&r.id&&r.id!=="default_user"){let p=!1;const s=i.some(u=>u.type==="Welcome Card"),n=localStorage.getItem("mcqkash_welcome_coins_pending");r.referred_by&&!s&&!n&&(i.push({id:"welcome_restored",type:"Welcome Card",coins:150,wallet:0,date:"Welcome"}),p=!0);const x=i.filter(u=>u.type==="Referral Card").length,f=Number(r.scratched_cards_count||0);if(x<f){const u=f-x;for(let g=0;g<u;g++)i.push({id:`ref_restored_${Date.now()}_${g}`,type:"Referral Card",coins:150,wallet:25,date:"Referred"});p=!0}p&&localStorage.setItem(t,JSON.stringify(i))}return i}catch{return[]}},G=()=>{const a=O();return a.length>0?a.reduce((t,i)=>t+(i.coins||0),0):0},C=()=>O().filter(t=>t.type==="Referral Card").length,L=()=>O().filter(t=>t.type==="Welcome Card").length,[F,b]=w.useState(null),[k,M]=w.useState(!1),[o,T]=w.useState(null),[z,R]=w.useState(!1);w.useEffect(()=>{k&&(r!=null&&r.referred_by)&&(async()=>{R(!0);try{const{data:t,error:i}=await A.rpc("get_public_profile_by_username",{target_username:r.referred_by});if(!i&&t){T(t),R(!1);return}}catch{console.warn("RPC failed, falling back to local storage cache")}try{const i=localStorage.getItem("mcqkash_lb_cache_coins");if(i){const{data:p}=JSON.parse(i),s=p.find(n=>{var x,f;return((x=n.username)==null?void 0:x.toLowerCase())===r.referred_by.toLowerCase()||((f=n.full_name)==null?void 0:f.toLowerCase())===r.referred_by.toLowerCase()});if(s){T({avatar_id:s.avatar_id||1,rank:s.rank||null,full_name:s.full_name||r.referred_by,is_pro:!!(s.pro_expires_at||s.pro_expiration)&&new Date(s.pro_expires_at||s.pro_expiration)>new Date||!!s.is_pro}),R(!1);return}}}catch{console.warn("Leaderboard cache search failed")}T({avatar_id:1,rank:null,full_name:r.referred_by,is_pro:!1}),R(!1)})()},[k,r==null?void 0:r.referred_by]),w.useEffect(()=>(k?(document.body.style.overflow="hidden",E&&E(!0)):document.body.style.overflow="unset",()=>{document.body.style.overflow="unset"}),[k]);const h=(r==null?void 0:r.premium_discount_earned)||0,Q=async()=>{const a=window.location.origin+(window.location.pathname.startsWith("/mcq")?"/mcq":"")+"/signin?ref="+encodeURIComponent((r==null?void 0:r.username)||""),t=`📚 Preparing for Competitive Exams?
...
Join me here --> ${a}`;if(navigator.share)try{await navigator.share({title:"MCQ Kash",text:t,url:a}),c("Referral shared successfully! 🚀","success")}catch(i){i.name!=="AbortError"&&(console.error("Web Share failed:",i),q(t))}else q(t)},q=a=>{navigator.clipboard.writeText(a),c("Share text copied to clipboard! 📋","success")},X=()=>new Promise(a=>{if(window.Razorpay)return a(!0);const t=document.createElement("script");t.src="https://checkout.razorpay.com/v1/checkout.js",t.onload=()=>a(!0),t.onerror=()=>a(!1),document.body.appendChild(t)}),Z=async a=>{if(!m){c("Sign In to upgrade your account!","warning"),j("/signin");return}if((r==null?void 0:r.user_tier)==="Pro"&&(r==null?void 0:r.pro_tier)===a.id){c("You are already on this plan!","info");return}b(a.id);try{if(!await X()){c("Failed to load Razorpay.","error"),b(null);return}const{data:{session:i}}=await A.auth.getSession();if(!(i!=null&&i.access_token)){c("Session expired. Sign in again.","warning"),j("/profile"),b(null);return}const p=i.access_token;let s,n,x,f;const u=await fetch(`${K}/create-order`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${p}`},body:JSON.stringify({planId:a.id})}),g=Math.max((a.floorPrice||9)*100,(a.price-h)*100);if(u.ok){const l=await u.json();l.amount&&Math.abs(l.amount-g)>50?(console.warn(`Remote Edge Function returned order amount ₹${l.amount/100}, but client expected ₹${g/100}. Using direct client checkout amount...`),s=null,n=g,x="INR",f=l.keyId||"rzp_live_SxuAK5B53kL3qS"):(s=l.orderId,n=l.amount,x=l.currency,f=l.keyId)}else console.warn("Remote Edge Function create-order failed, using direct client checkout amount..."),s=null,n=g,x="INR",f="rzp_live_SxuAK5B53kL3qS";const W={key:f,amount:a.id==="ONE_DAY"||a.id==="ONE_HOUR"?900:n,currency:x||"INR",name:"MCQ Kash",description:`${a.name} Pro Upgrade`,prefill:{email:m.email},theme:{color:a.featured?"#a855f7":"#f59e0b"},modal:{ondismiss:()=>{b(null),c("Cancelled.","info")}},handler:async l=>{try{let N=!1,y=null,_=null;try{y=await fetch(`${K}/verify-payment`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${p}`},body:JSON.stringify({razorpay_order_id:l.razorpay_order_id||"test_order_1day",razorpay_payment_id:l.razorpay_payment_id,razorpay_signature:l.razorpay_signature||"test_sig",planId:a.id})})}catch(d){_=d,console.warn("Network fetch to verify-payment failed:",d.message)}if(y&&y.ok){const{success:d}=await y.json();N=d}else{const d=y?await y.json().catch(()=>({})):{};if(console.warn("Backend verify-payment non-200 or network error, attempting client fallback profile sync...",d,_),l.razorpay_payment_id){const S=new Date,P=a.days||(a.id==="ONE_DAY"||a.id==="ONE_HOUR"?1:30);S.setTime(S.getTime()+Math.round(P*24*60*60*1e3));const I=S.toISOString();localStorage.setItem(`mcqkash_pro_override_${m.id}`,JSON.stringify({is_pro:!0,pro_tier:a.id,pro_expiration:I,pro_expires_at:I}));const ee=a.id==="ONE_DAY"||a.id==="ONE_HOUR"?"ONE_DAY":a.id,{error:Y}=await A.from("profiles").update({is_pro:!0,pro_tier:ee,pro_expiration:I,pro_expires_at:I}).eq("id",m.id);Y&&console.warn("Client DB update notice (handled by local override):",Y.message),N=!0}else throw new Error(d.error||(_==null?void 0:_.message)||"Payment verification failed.")}if(N){const d=new Date,S=a.days||30;d.setTime(d.getTime()+Math.round(S*24*60*60*1e3));const P=d.toISOString();localStorage.setItem(`mcqkash_pro_override_${m.id}`,JSON.stringify({is_pro:!0,pro_tier:a.id,pro_expiration:P,pro_expires_at:P})),localStorage.removeItem(`mcqkash_profile_cache_${m.id}`),localStorage.removeItem(`mcqkash_ranks_cache_${m.id}`),localStorage.removeItem("mcqkash_lb_cache_coins"),localStorage.removeItem("mcqkash_lb_cache_streaks"),we({particleCount:180,spread:100,origin:{y:.5},colors:["#fbbf24","#a855f7","#6366f1","#10b981","#f43f5e"]}),c("Welcome to Pro! ★","success"),await E(!0),window.dispatchEvent(new Event("sync-profile-stats")),setTimeout(()=>j("/profile"),1200)}}catch(N){c(N.message||"Verification failed.","error")}finally{b(null)}}};s&&(W.order_id=s),new window.Razorpay(W).open()}catch(t){c(t.message||"Checkout failed.","error"),b(null)}},H=(r==null?void 0:r.user_tier)==="Pro";return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
